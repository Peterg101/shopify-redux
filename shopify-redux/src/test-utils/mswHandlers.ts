...
export const handlers = [
  ...
  http.get(`${AUTH_BASE}/user_basket`, () => {
    return HttpResponse.json([])
  }),

  http.get(`${AUTH_BASE}/user_orders`, () => {
    return HttpResponse.json([])
  }),

  http.get(`${AUTH_BASE}/user_claims`, () => {
    return HttpResponse.json([])
  }),

  http.get(`${AUTH_BASE}/user_claimable`, () => {
    return HttpResponse.json([])
  }),

  http.get(`${AUTH_BASE}/user_tasks`, () => {
    return HttpResponse.json([])
  }),
